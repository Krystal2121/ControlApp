...
GO
/*
The column [dbo].[FileStore].[FileName] on table [dbo].[FileStore] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering Table [dbo].[FileStore]...';


GO
ALTER TABLE [dbo].[FileStore]
    ADD [FileName] VARCHAR (250) NOT NULL;
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			(CmdId,VarBin, FileName)
			Select @cmdid, @file, @filename
		END
	END
