...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[ControlAppCmd]...';


GO
ALTER TABLE [dbo].[ControlAppCmd] DROP CONSTRAINT [DF__tmp_ms_xx__Sende__3F115E1A];
...
GO
ALTER TABLE [dbo].[ControlAppCmd] DROP CONSTRAINT [DF__tmp_ms_xx__SendD__40058253];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_ControlAppCmd] ([Id], [SenderId], [SubId], [GroupRefId])
        SELECT   [Id],
                 [SenderId],
                 [SubId],
                 [GroupRefId]
...
AS
	...
	@message)
GO
PRINT N'Refreshing Procedure [dbo].[USP_DeleteOutstanding]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_DeleteOutstanding]';
