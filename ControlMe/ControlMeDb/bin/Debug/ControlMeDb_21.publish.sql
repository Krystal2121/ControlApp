...
GO
/*
The column [dbo].[FileStore].[VarBin] is being dropped, data loss could occur.

The column [dbo].[FileStore].[fpsloc] on table [dbo].[FileStore] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
ALTER TABLE [dbo].[FileStore] DROP CONSTRAINT [DF__tmp_ms_xx__Uploa__625A9A57];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_FileStore] ([Id], [CmdId], [UploadDate], [FileName])
        SELECT   [Id],
                 [CmdId],
                 [UploadDate],
                 [FileName]
