...
GO
PRINT N'Altering Procedure [dbo].[USP_Register]...';


GO
ALTER PROCEDURE [dbo].[USP_Register]
...
GO
PRINT N'Creating Procedure [dbo].[USP_GetUserSettings]...';
...
CREATE PROCEDURE [dbo].[USP_GetUserSettings]
	@userid varchar(max)
AS
	SELECT * from Users where [Screen Name]=@userid
RETURN 0
GO
